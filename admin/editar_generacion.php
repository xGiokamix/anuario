...
<html lang="es" data-bs-theme="auto">
 <head><script src="../assets/color-modes.js"></script>
    ...
    <meta name="author" content="Giokami,Mark Otto, Jacob Thornton, and Bootstrap contributors">
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Administrador</a>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Editar Generación</h1>
        </div>
            <form action='editar_generacion.php'>
        ...
        <h1 class="h3 mb-3 fw-normal" style="text-align: center">
          ...
          <div class="form-floating">
            <input
              ...
              class="form-control"
              id="floatingInput"
              placeholder="Id Generación"
              name="id_generacion"
            />
            <label for="floatingInput">ID Generación</label>
          </div>
          <div class="form-floating">
            <input
              type="input"
